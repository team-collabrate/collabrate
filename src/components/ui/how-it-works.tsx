    ...
    >
      <div className="bg-white dark:bg-neutral-900 p-2 rounded-[25px] shadow-[0px_10px_20px_0px_#D3D3D3] dark:shadow-none border border-neutral-100 dark:border-neutral-800">
        ...
        >
          ...
          <h3 className="text-2xl font-semibold text-neutral-800 dark:text-neutral-100 leading-tight mb-[10px]">
            {title}
            {duration && (
              <span className="block text-xs font-normal text-neutral-400 dark:text-neutral-500 mt-1 tracking-wide">
                {duration}
              </span>
            )}
          </h3>
